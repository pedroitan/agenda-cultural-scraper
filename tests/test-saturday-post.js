...
async function testSaturdayPost() {
  console.log('\n🧪 Testing Saturday Post\n')
  console.log('Post: https://www.instagram.com/p/DWaHRd0jUkN/')
  ...
  let targetPost = posts.find(p => p.url.includes('DWaHRd0jUkN'))
  
  if (!targetPost) {
    console.log('⚠️  Post específico não encontrado na lista')
